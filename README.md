...
├── scripts/
│   └── generate_confusion_matrix.py  # generates confusion matrix visualization
...
**Per-class accuracy on test set (40 images):**
- bus: 100%
- car: 100%
- motorcycle: 100%
- truck: 100%

*Note: Test set is small (40 images, 10 per class). The 90% validation accuracy on 320 images is a more reliable metric.*
